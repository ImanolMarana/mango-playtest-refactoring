...
public final class TypeResolver {
  ...
  private static void populateTypeMappings(
    ...
    new TypeVisitor() {
      ...
      void visitWildcardType(WildcardType fromWildcardType) {
        populateWildcardTypeMappings(mappings, fromWildcardType, to);
      }

      @Override
      void visitParameterizedType(ParameterizedType fromParameterizedType) {
        populateParameterizedTypeMappings(mappings, fromParameterizedType, to);
      }
  ...
  private static void populateWildcardTypeMappings(
    final Map<TypeVariableKey, Type> mappings, WildcardType fromWildcardType, final Type to) {
  ...
  private static void populateParameterizedTypeMappings(
    final Map<TypeVariableKey, Type> mappings, ParameterizedType fromParameterizedType, final Type to) {
